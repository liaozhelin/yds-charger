/*
 * @Author: [LiaoZhelin]
 * @Date: 2022-04-02 18:53:19
 * @LastEditors: [LiaoZhelin]
 * @LastEditTime: 2022-05-12 00:32:35
 * @Description: 
 */
#include <stdio.h>
#include <string.h>
...
uint8_t u8g2_esp32_i2c_byte_cb(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr) {
	...
	switch(msg) {
		...
		case U8X8_MSG_BYTE_INIT: {
...
#if CONFIG_U8G2_INIT_I2C_ENABLE
		    ...
		    conf.master.clk_speed = CONFIG_U8G2_I2C_SPEED;
...
//				printf("%c",(arg_int==1?'D':'d'));
	...
	// Delay for the number of milliseconds passed in through arg_int.
		...
		case U8X8_MSG_GPIO_MENU_UP:
			u8x8_SetGPIOResult(u8x8,gpio_get_level(9));
			break;
		case U8X8_MSG_GPIO_MENU_DOWN:
			u8x8_SetGPIOResult(u8x8,gpio_get_level(10));
			break;
		case U8X8_MSG_GPIO_MENU_SELECT:
			u8x8_SetGPIOResult(u8x8,gpio_get_level(8));
			break;
	}
	return 0;
...
void u8g2_Init(void){
	...
	u8g2_esp32_hal.sda = CONFIG_U8G2_I2C_SDA;
	u8g2_esp32_hal.scl = CONFIG_U8G2_I2C_SCL;
	...
	u8x8_SetI2CAddress(&u8g2.u8x8,CONFIG_U8G2_I2C_ADDRESS);
